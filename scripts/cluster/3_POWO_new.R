...
package_vec <- c(
  "dplyr", "tidyverse", "sf", "lwgeom", "foreach", "doParallel" # names of the packages required placed here as character objects
)
...
save(occ_tdwg_sf, file = paste0(path_imp, "/output/intermediate/occurrences_tdwg_region_sf.RData"))
...
save(occ_tdwg_sf, file = paste0(path_imp, "/output/intermediate/occ_tdwg_sf.RData"))
...
save(all_specs_occ_status, file = paste0(path_imp, "/output/intermediate/all_specs_occ_status.RData"))
